package ru.gamehub.web.application.user.register;
 ...
 * <b>Исключения:</b>
 * <ul>
 *   <li>{@link ru.gamehub.web.domain.user.exception.UserAlreadyExistsException} — если пользователь с таким email уже существует.</li>
 *   <li>{@link ru.gamehub.web.domain.user.exception.UserRegistrationException} — если произошла ошибка при регистрации в Keycloak.</li>
 * </ul>
 *
...
public class RegisterUserService {
     ...
     * @throws ru.gamehub.web.domain.user.exception.UserAlreadyExistsException если email уже зарегистрирован
     * @throws ru.gamehub.web.domain.user.exception.UserRegistrationException если регистрация в Keycloak завершилась ошибкой
     */
    @Transactional
