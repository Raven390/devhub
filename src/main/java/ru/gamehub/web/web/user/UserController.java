package ru.gamehub.web.web.user;
...
import ru.gamehub.web.application.user.search.SearchUserQuery;
import ru.gamehub.web.application.user.search.SearchUserService;
import ru.gamehub.web.domain.user.User;
import ru.gamehub.web.web.user.dto.response.UserSearchResponse;
