package ru.gamehub.web.infrastructure.jpa.project.model;
 ...
 * </ul>
 *
 * @see ru.gamehub.web.infrastructure.jpa.user.UserJpaEntity
 * @see ru.gamehub.web.domain.project.Project
