package ru.gamehub.web.domain.reference.project.type;
...
public class ProjectTypePage {
    ...
    private ProjectTypePage(List<ProjectType> projectTypes, long total, int page, int size) {
    ...
    public static ProjectTypePage create(List<ProjectType> projectTypes, long total, int page, int size) {
        return new ProjectTypePage(projectTypes, total, page, size);
    }
