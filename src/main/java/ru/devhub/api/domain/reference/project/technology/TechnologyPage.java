...
public class TechnologyPage {
    ...
    private TechnologyPage(List<Technology> technologies, long total, int page, int size) {
    ...
    public static TechnologyPage create(List<Technology> projects, long total, int page, int size) {
        return new TechnologyPage(projects, total, page, size);
    }
