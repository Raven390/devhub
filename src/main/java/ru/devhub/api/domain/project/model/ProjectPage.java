package ru.devhub.api.domain.project.model;
...
public class ProjectPage {
    ...
    private ProjectPage(List<Project> projects, long total, int page, int size) {
    ...
    public static ProjectPage create(List<Project> projects, long total, int page, int size) {
        return new ProjectPage(projects, total, page, size);
    }
