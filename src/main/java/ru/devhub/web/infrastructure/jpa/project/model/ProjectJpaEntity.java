package ru.devhub.web.infrastructure.jpa.project.model;
...
import ru.devhub.web.infrastructure.jpa.project.ProjectJpaRepository;
 ...
 * <p>
 * Представляет таблицу <b>DevHub.project</b> и служит инфраструктурным отображением доменной сущности проекта для ORM-слоя.
