...
public class CreateProjectServiceTest {
    ...
    void shouldCreateProject() {
        ...
        CreateProjectCommand createProjectCommand = new CreateProjectCommand(owner, name, description);
    ...
    void shouldSetTimestampsOnProjectCreation() {
        ...
        CreateProjectCommand command = new CreateProjectCommand(owner, name, description);
