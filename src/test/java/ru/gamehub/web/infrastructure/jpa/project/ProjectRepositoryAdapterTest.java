    ...
    void save_handles_nonEmptyMembers_as_refs_and_returns_mappedDomain() {
        ...
        Project domainWithMembers = Project.builder()
                ...
                .members(List.of(
                        ...
                        ru.gamehub.web.domain.project.member.ProjectMember.create(
                                m1, UUID.randomUUID(), User.create(UUID.randomUUID()), List.of(), ru.gamehub.web.domain.project.member.ProjectMemberStatus.ACTIVE, null, null
                        ),
                        ru.gamehub.web.domain.project.member.ProjectMember.create(
                                m2, UUID.randomUUID(), User.create(UUID.randomUUID()), List.of(), ru.gamehub.web.domain.project.member.ProjectMemberStatus.ACTIVE, null, null
                        )
                ))
                .build();
