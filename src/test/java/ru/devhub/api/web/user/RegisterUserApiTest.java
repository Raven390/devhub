...
import ru.devhub.api.application.user.register.RegisterUserCommand;
import ru.devhub.api.application.user.register.RegisterUserService;
...
import ru.devhub.api.web.user.auth.AuthController;
import ru.devhub.api.web.user.auth.dto.RegisterUserRequest;
import ru.devhub.api.web.user.auth.dto.RegisterUserResponse;
import ru.devhub.api.web.user.auth.mapper.RegisterUserMapper;
